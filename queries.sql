...
VALUES
('C124','Sammy2','145 Main St','2025-06-01'),
('C125','Ammy2','148 Main St','2025-05-01'),
('C126','Joshua2','158 Main St','2025-04-01');
...
SELECT 
     m.member_name, 
	 b.book_title,
	 COUNT(ist.issued_id) AS damaged_book_cnt
FROM members as m
JOIN issued_status AS ist 
ON m.member_id = ist.issued_member_id
JOIN books AS b 
...
ORDER BY damaged_book_cnt DESC;
...
SELECT 
	   ...
	   SUM(
          (CURRENT_DATE - ist.issued_date)*0.50
	   )AS total_fines
FROM issued_status AS ist
